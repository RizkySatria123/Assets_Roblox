...
straw = make_mat("Straw", (0.85, 0.75, 0.5))
black = make_mat("Black", (0.05, 0.05, 0.05))
...
bpy.ops.mesh.primitive_cone_add(vertices=24, radius1=1.6, radius2=0.1, depth=0.7, location=(0, 0, 2.25))
...
hat.data.materials.append(straw)
